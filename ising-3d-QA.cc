  ...
  for (int i = 0; i < Nx; i++) {
    for (int j = 0; j < Ny; j++) {
      for (int k = 0; k < Nz; k++) {
        // for (int l=0; l<Nt; l++)
        //{
        fout3 << i << ' ' << j << ' ' << k << ' ' << sz[i][j][k][0] << ' '
              << sz[i][j][k][1] << ' ' << sz[i][j][k][2] << ' '
              << sz[i][j][k][3] << ' ' << sz[i][j][k][4] << ' '
              << sz[i][j][k][5] << ' ' << sz[i][j][k][6] << ' '
              << sz[i][j][k][7] << ' ' << sz[i][j][k][8] << ' '
              << sz[i][j][k][9] << endl;
        fout30 << i << ' ' << j << ' ' << k << ' ' << sz[i][j][k][0] << endl;
        //}
      }
    }
    fout3 << ' ' << endl;
